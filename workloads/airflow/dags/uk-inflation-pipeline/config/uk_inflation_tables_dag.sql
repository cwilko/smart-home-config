...
-- =============================================================================
-- Helper Functions for Sort Order (safe to recreate)
-- =============================================================================
...
CREATE OR REPLACE VIEW uk_inflation_yoy_ready AS
SELECT 
    current.date,
    current.coicop_id,
    current.series_type,
...
CREATE OR REPLACE VIEW uk_inflation_hierarchy_tree AS
...
'COICOP classification hierarchy for UK inflation data. Supports 5-level structure (0-4) with 00 as root.';
...
DO $$
BEGIN
    RAISE NOTICE 'UK Inflation tables initialized successfully (DAG-safe version)!';
